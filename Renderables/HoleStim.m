classdef HoleStim < Renderable
    ...
    methods
        function obj = HoleStim(ori, spat_freq, temp_freq, contrast, phase, figure_sz, ground_sz)
            ...
            if nargin < 6 || isempty(figure_sz)
                figure_sz = nan;
            end

            if nargin < 7 || isempty(ground_sz)
                ground_sz = nan;
            end
            ...
            obj.figure_sz = figure_sz;
            obj.ground_sz = ground_sz;
        end
        ...
        function initialize(obj)
            ...
            obj.gratingtex = CreateProceduralSineGrating(obj.getWindow(), obj.patch_size, obj.patch_size, [0.5 0.5 0.5 0.0], [], obj.contrast);
            obj.holetex = CreateProceduralSineGrating(obj.getWindow(), obj.patch_size, obj.patch_size, [0.5 0.5 0.5 0.0], [], 0);
        ...
        function draw(obj, t_close)
            ...
            while obj.renderer.getTime() < t_close
                ...
                Screen('DrawTexture',obj.getWindow(), obj.holetex, obj.getRect(obj.figure_sz), obj.getRect(obj.figure_sz), obj.ori, [], [], [], [], obj.rotate_mode, [phase, obj.spat_freq, obj.amplitude, 0]); % subsample
